...
const DashboardCard = ({
  ...
  >
    ...
    <button className="self-start px-4 py-2 mt-auto transition-all ease-in-out duration-150 text-white active:scale-[0.98] bg-red-500 rounded-md hover:bg-red-600">
      {buttonLabel}
    </button>
  </Link>
);
